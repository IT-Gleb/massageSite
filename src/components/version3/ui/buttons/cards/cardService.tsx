...
export const CardService: FC<TCardItemProps> = ({ title, imageSrc, index }) => {
  return (
    <article className="flex items-start gap-x-2 border border-green-700/50 shadow-sm bg-green-300/20">
      ...
      <main className="flex-auto flex items-start justify-end">
        ...
        <div className="w-[60px] h-[60px] sm:h-[65px] bg-green-200 flex-grow overflow-hidden rounded-es-full">
          <span className="block text-slate-400 w-fit mx-auto pt-4 text-[6vw]/[6.1wv] sm:pt-1 sm:text-[2em]/[2.1em] md:text-[1.6em]/[1.6em] md:pt-0 lg:pt-3 lg:text-[1.5em]/[1.5em] xl:pt-1 font-oswald">
            {index}
          </span>
        </div>
      </main>
