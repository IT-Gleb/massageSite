    ...
    <article
      ...
      className={`max-[365px]:w-[268px] w-[275px] md:w-[320px] h-[240px] bg-emerald-50 dark:bg-slate-100 ${
        param.index === param.activeIndex
          ? "border-4 border-emerald-700 dark:border-stone-400"
          : ""
      } relative`}
    >
      ...
      <div className="absolute left-2 top-[64px] w-[90px] h-[90px] rounded-full bg-emerald-300 dark:bg-slate-500 overflow-hidden content-center text-center">
      ...
      />
      <p className="indent-4 text-[clamp(0.7rem,4vw,1rem)]/[clamp(0.7rem,4vw,1rem)] mt-0 p-1 text-balance text-emerald-600 dark:text-slate-600">
        {param.text}
      </p>
