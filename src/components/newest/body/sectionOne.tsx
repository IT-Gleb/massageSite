      ...
      "
        ...
        dark:bg-[linear-gradient(to_right,theme(colors.transparent)_0%,theme(colors.slate.800)_10%,theme(colors.transparent))]"
          ...
          <p>
            ...
            Выводятся токсины, ускоряется обмен веществ, снижается вес,
            пассивная нагрузка для людей с малоподвижным образом жизни, отличные
            результаты при поблемах в органах малого таза (простатит, бесплодие
            и др.). Массаж проводится по мередианам и биологически активным
            точкам. Очущения приятные, сопровождаются легкой вибрацией.
          </p>
